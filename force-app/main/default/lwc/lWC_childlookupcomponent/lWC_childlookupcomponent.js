...
import fetchLookupData from '@salesforce/apex/lookupAccountController.fetchLookupData';
const DELAY = 300;
export default class LWC_LookupComponent extends LightningElement {
    @api label = 'custom lookup label';
    @api placeholder = 'search...'; 
    @api iconName = 'standar';
    @api sObjectApiName = '';
    @api defaultRecordId = '';
...
// send selected lookup record to parent component using custom event
    ...
    console.log("RecordName", JSON.stringify(value));
